...
La fonction \texttt{\textbf{CreateStack}} permet également d'harmoniser plus de 2 rasters à partir d'une liste, le premier servant également de référence. cette fonction permet également de découper l'ensemble des rasters selon un périmètre
